...
/*
  ...
  File Name: waebric.flex
  To Create: > jflex waebric.flex

  and then after the parser is created
  > javac WaebricLexer.java
*/
...
<YYINITIAL> {
    ...
    "("                { System.out.print(" ( "); return symbol(sym.LEFT); }
    ")"                { System.out.print(" ) "); return symbol(sym.RIGHT); }
