/*
 * File			: RecursiveMenusOutputTest.java
...
public class RecursiveMenusOutputTest extends TestCase {
	...
	public static final String OUTPUTTEST_FUNCTION_THE_MENU = 	"def(\"the-menu\",formals([]),[markup(call(tag(\"menu\",[]),args([record([pair(\"title\",text(\"\\\"Menu\\\"\")),pair(\"kids\",list([record([pair(\"title\",text(\"\\\"Home\\\"\")),pair(\"link\",text(\"\\\"/\\\"\"))]),record([pair(\"title\",text(\"\\\"Misc\\\"\")),pair(\"kids\",list([record([pair(\"title\",text(\"\\\"Contact\\\"\")),pair(\"link\",text(\"\\\"contact.html\\\"\"))]),record([pair(\"title\",text(\"\\\"Links\\\"\")),pair(\"link\",text(\"\\\"links.html\\\"\"))])]))])]))])])))])";
