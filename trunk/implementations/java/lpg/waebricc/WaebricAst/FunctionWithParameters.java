...
/**
 *<b>
 *<li>Rule 16:  Function ::= def IDENTIFIER$Name ParameterDeclOpt StatementOpt end
 *</b>
 */
public class FunctionWithParameters extends Ast implements IFunction
{
    ...
    public FunctionWithParameters(IToken leftIToken, IToken rightIToken,
                                  AstToken _Name,
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof FunctionWithParameters)) return false;
        if (! super.equals(o)) return false;
        FunctionWithParameters other = (FunctionWithParameters) o;
