...
public final class AMarkupExpStatement extends PStatement
{
    private final LinkedList<PMarkup> _markup_ = new LinkedList<PMarkup>();
    private PExpression _expression_;

    public AMarkupExpStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMarkupExpStatement(
    ...
    {
        ((Analysis) sw).caseAMarkupExpStatement(this);
    }
