...
public final class AFunctionModuleElement extends PModuleElement
{
    private PFunction _function_;

    public AFunctionModuleElement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctionModuleElement(
            cloneNode(this._function_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFunctionModuleElement(this);
    }
