...
public final class AIdconExpressionNoPlus extends PExpressionNoPlus
{
    private TIdCon _idCon_;

    public AIdconExpressionNoPlus()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdconExpressionNoPlus(
            cloneNode(this._idCon_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAIdconExpressionNoPlus(this);
    }
