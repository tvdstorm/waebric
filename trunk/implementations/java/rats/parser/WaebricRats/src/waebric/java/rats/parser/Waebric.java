...
// on Friday, July 31, 2009 at 1:51:46 PM.
...
public final class Waebric extends ParserBase {
      ...
      if (Character.isLetter(start)) {
        ...
        while (true) {
          ...
          if (-1 != yyC) {
            ...
            if ((Character.isLetterOrDigit(part) || part == '-')) {
  ...
  private Result pFormals(final int yyStart) throws IOException {
    WaebricColumn yyColumn = (WaebricColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fFormals) 
      yyColumn.chunk2.fFormals = pFormals$1(yyStart);
    return yyColumn.chunk2.fFormals;
  }
