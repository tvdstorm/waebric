...
private void f(final Writer $out, final Markup $markup, final Object x) 
	throws IOException, SQLException {
	
{
final Object x = "Goodbye!";
g($out, $nil, x);    
}
...
private void g(final Writer $out, final Markup $markup, final Object x) 
	throws IOException, SQLException {
