...
private void f(final Writer $out, final Markup $markup, final Object x, final Object y) 
	throws IOException, SQLException {
...
public void f(final Writer $out, final Object x, final Object y)
	throws IOException, SQLException {
	f($out, $nil, x, y);
}
