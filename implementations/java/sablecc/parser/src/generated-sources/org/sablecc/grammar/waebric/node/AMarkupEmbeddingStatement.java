...
public final class AMarkupEmbeddingStatement extends PStatement
{
    private final LinkedList<PMarkup> _markup_ = new LinkedList<PMarkup>();
    private PEmbedding _embedding_;

    public AMarkupEmbeddingStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMarkupEmbeddingStatement(
    ...
    {
        ((Analysis) sw).caseAMarkupEmbeddingStatement(this);
    }
