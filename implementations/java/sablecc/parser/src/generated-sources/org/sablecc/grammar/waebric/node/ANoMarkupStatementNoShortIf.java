...
public final class ANoMarkupStatementNoShortIf extends PStatementNoShortIf
{
    private PStatementNoMarkupNoShortIf _statementNoMarkupNoShortIf_;

    public ANoMarkupStatementNoShortIf()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANoMarkupStatementNoShortIf(
            cloneNode(this._statementNoMarkupNoShortIf_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseANoMarkupStatementNoShortIf(this);
    }
