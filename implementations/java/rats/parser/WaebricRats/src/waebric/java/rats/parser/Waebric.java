...
// on Friday, July 31, 2009 at 4:01:22 PM.
...
public final class Waebric extends ParserBase {
  ...
  private Result pVar(final int yyStart) throws IOException {
    WaebricColumn yyColumn = (WaebricColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fVar) yyColumn.chunk2.fVar = pVar$1(yyStart);
    return yyColumn.chunk2.fVar;
  }

  /** Actually parse waebric.java.rats.parser.Expressions.Var. */
  ...
  /**
   * Parse nonterminal waebric.java.rats.parser.Expressions.Symbol.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pFormals$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Node> v$l$2 = yyResult.semanticValue();
  ...
  private Result pEmbed$1(final int yyStart) throws IOException {
    ...
    yyResult = pEmbed$$Plus2(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Pair<Node> v$g$4 = yyResult.semanticValue();

      yyValue = GNode.create("Embed", v$g$4);

      return yyResult.createValue(yyValue, yyError);
    }

    // Done.
    yyError = yyError.select("embed expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse synthetic nonterminal 
   * waebric.java.rats.parser.Waebric.Embed$$Plus2.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pEmbed$$Plus2(final int yyStart) throws IOException {
    WaebricColumn yyColumn = (WaebricColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fEmbed$$Plus2) 
      yyColumn.chunk4.fEmbed$$Plus2 = pEmbed$$Plus2$1(yyStart);
    return yyColumn.chunk4.fEmbed$$Plus2;
  }

  /** Actually parse waebric.java.rats.parser.Waebric.Embed$$Plus2. */
  private Result pEmbed$$Plus2$1(final int yyStart) throws IOException {
    Result     yyResult;
    Pair<Node> yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pEmbed$$Plus2(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
