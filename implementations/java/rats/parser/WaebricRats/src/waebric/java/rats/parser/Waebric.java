...
// on Friday, July 31, 2009 at 3:50:39 PM.
...
public final class Waebric extends ParserBase {
  ...
  private Result pFormals$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      String v$l$1 = yyResult.semanticValue();

      yyResult = pFormals$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<String> v$l$2 = yyResult.semanticValue();
  ...
  private Result pEmbed$$Plus2(final int yyStart) throws IOException {
    WaebricColumn yyColumn = (WaebricColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fEmbed$$Plus2) 
      yyColumn.chunk3.fEmbed$$Plus2 = pEmbed$$Plus2$1(yyStart);
    return yyColumn.chunk3.fEmbed$$Plus2;
  }
