...
public class WaebricParser/* @bgen(jjtree) */implements
		WaebricParserTreeConstants, WaebricParserConstants {/* @bgen(jjtree) */
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			System.out
					.println("No arguments found: Please run -> WaebricParser filename.wae");
	...
	public static String parse(String filename) {
		...
		try {
			sr = new FileReader(new File(filename));
		...
		try {
			...
			/*
			 * Code to produce a tree dump of the original jjTree. can be really
			 * useful for debugging so we decided to leave it in.
			 * System.out.println("");
	...
	public static String buildAST(Node n, int childIndex) {
	...
	static final private void Module() throws ParseException {
		/* @bgen(jjtree) Module */
	...
	static final public void ModuleId() throws ParseException {
	...
	static final public void Path() throws ParseException {
		...
		try {
			...
			case FileName:
				...
				jjtree.closeNodeScope(jjtn000, true);
				jjtc000 = false;
				jjtn000.image += "path-file:" + token.image;
				break;
			case DirName:
				jj_consume_token(DirName);
				jjtn000.image += "path-dirfile:"
						+ token.image.substring(0, token.image.length() - 1)
						+ ":";
				jj_consume_token(FileName);
				jjtree.closeNodeScope(jjtn000, true);
				jjtc000 = false;
	...
	static final public void Statement() throws ParseException {
		...
		try {
			...
			case COMMENT:
				...
				jjtn000.image = "comment:" + token.image;
				jj_consume_token(SEMICOLON);
				break;
			default:
				jj_la1[21] = jj_gen;
	...
	static final public void Assignment() throws ParseException {
		...
		try {
			if (jj_2_14(2)) {
				jj_consume_token(IdCon);
				jjtn000.image = "func-bind:" + token.image;
				Formals();
				jj_consume_token(ASSIGN);
				Statement();
			} else if (jj_2_15(2)) {
				jj_consume_token(IdCon);
				jjtn000.image = "var-bind:" + token.image;
				jj_consume_token(ASSIGN);
				Expression();
				jj_consume_token(SEMICOLON);
			} else {
	...
	/*
	 * Note: The Expression: Expression() <DOT> <IdCon> has been transformed
	 * using the methods described in the paper:
	 * "Removing Left Recursion from Context-Free Grammars" by Robert C. Moore.
	 * The result of this transformation was not without problems in JavaCC.
	 * This is why the production DotIdCon() was brought into life. It is placed
	 * behind each and every call to Expression() in the following way:
	 * Expression() (DotIdCon())?. It would be better to keep this inside
	 * expression, but attempts in doing so have been unsuccesful thusfar.
	 */
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x80, 0xb00, 0x0, 0x0, 0xb00, 0x0, 0x40000000,
				0x0, 0x1000000, 0x101ed000, 0x0, 0x0, 0x0, 0x0, 0x101ed000,
				0x0, 0x0, 0x0, 0x0, 0x101ed000, 0x0, 0x60000, 0x5000, 0x108000,
				0x0, 0x0, 0x14000000, 0x0, 0x1000000, 0x80000000, 0x80000000,
				0x0, 0x14000000, 0x0, 0x0, 0x0, 0x14000000, 0x14000000, 0x0,
				0x0, 0x0, 0x0, 0x14000000, 0x0, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x2, 0x8000, 0x0, 0x2800, 0x0, 0x2800,
				0x0, 0x8000, 0x8000, 0x1, 0x8000, 0x8000, 0x8000, 0x2, 0x2,
				0x2, 0x8000, 0x8000, 0x2, 0x0, 0x0, 0x0, 0x2, 0x2, 0x78000,
				0x30000000, 0x0, 0x2e, 0xe, 0x20, 0x78000, 0x1, 0x2, 0x2,
				0x78000, 0x78000, 0x2, 0x1, 0x8000, 0x1, 0x78000, 0x2, };
	}
