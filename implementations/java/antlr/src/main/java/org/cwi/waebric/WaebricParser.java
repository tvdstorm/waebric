// $ANTLR 3.1.2 /Users/Jeroen/Documents/workspace/WaebricANTLR/src/main/grammar/Waebric.g 2009-08-29 17:40:10
...
public class WaebricParser extends Parser {
    ...
    public final WaebricParser.module_return module() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: imprt, site, function, moduleId, 40
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt25) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: predicate, statement, 58, statement, 57
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: statement, 59, 50, 48, expression, IDCON, 43
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: 61, assignment, statement, 60, END
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
