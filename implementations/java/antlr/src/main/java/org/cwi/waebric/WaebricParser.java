...
public class WaebricParser extends Parser {
    ...
    public final WaebricParser.module_return module() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: function, site, moduleId, 34, imprt
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt29) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: predicate, statement, 44, 42, statement, 53, 52
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: 42, 44, 54, 37, statement, IDCON, expression
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: END, assignment, 55, 56, statement
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 6 :
                    ...
                    // AST REWRITE
                    // elements: expression, SEMICOLON, 57
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 8 :
                    ...
                    // AST REWRITE
                    // elements: 58, SEMICOLON, expression
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
