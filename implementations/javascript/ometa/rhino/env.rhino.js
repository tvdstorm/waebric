 ...
 * 
 * Bugfix by @author Nickolas : Activated the namespace of nodes + removed auto creation tbody in table
 *  
 * @author John Resig
 * @author thatcher
 */
 ...
 * @return : int
 */
var __findNamedItemIndex__ = function(namednodemap, name, ns) {
  var ret = -1;
  ...
  for (var i=0; i<namednodemap.length; i++) {
   ...
   if(namednodemap[i].namespaceURI){
		foundName = namednodemap[i].namespaceURI + ':' + namednodemap[i].name;
   }else{
   		foundName = namednodemap[i].name;
   }
    
   if (foundName == searchName) {         // found it!
      ret = i;
      break;
    } 
  }
...
__extend__(DOMAttr.prototype, {
    ...
    get xml(){
		if (this.namespaceURI != '') {
			return this.namespaceURI + ':' + this.nodeName + '="' + __escapeXML__(this.nodeValue) + '" ';
		}else{
...
__extend__(DOMElement.prototype, {	
    ...
    setAttributeNS : function(namespaceURI, qualifiedName, value) {
        ...
        var attr = this.attributes.getNamedItemNS(namespaceURI, qualifiedName);
